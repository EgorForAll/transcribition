...
# Демо-стенд транскрипции аудио

Интерактивный демо-стенд для сервиса транскрипции аудио в текст.

## Быстрый старт

### Запуск через Docker Compose:
```bash
# Запуск всей системы (API + демо-стенд)
docker-compose -d --build
```

Доступ к демо-стенду: http://localhost:8501
